...
- +256 - For each additional BGGP challenge your entry meets the requirements for. eg a palindromic (1) self-replicating (3) polyglot (2) that downloads a file (5) within the process memory (4) would give you +1280 points.
...
In short, here are the combo points you can get for each challenge you do.
- BGGP1 +256
- BGGP2 +256
- BGGP3 +256
- BGGP4 +256
